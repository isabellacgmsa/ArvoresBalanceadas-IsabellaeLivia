...
## ✨ Funcionalidades Principais
  ...
  * **Funções de Listagem:**
      * **Listar (AVL):** Exibe a lista completa de produtos em ordem alfabética (percurso *In-Order*).
...
Este projeto é totalmente *frontend* e não requer *backend* ou dependências externas.
